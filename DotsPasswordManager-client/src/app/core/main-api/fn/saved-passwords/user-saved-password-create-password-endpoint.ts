...
export function userSavedPasswordCreatePasswordEndpoint(
  http: HttpClient,
  rootUrl: string,
  params: UserSavedPasswordCreatePasswordEndpoint$Params,
  context?: HttpContext
): Observable<StrictHttpResponse<UserSavedPasswordCreatePasswordResponse>> {
  const rb = new RequestBuilder(
    rootUrl,
    userSavedPasswordCreatePasswordEndpoint.PATH,
    'post'
  );
  if (params) {
...
userSavedPasswordCreatePasswordEndpoint.PATH = '/saved-passwords';
