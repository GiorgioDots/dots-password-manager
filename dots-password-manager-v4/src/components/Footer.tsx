export default function Footer() {
  ...
  return (
    <footer className="mt-10 border-t border-border/80 px-4 py-3 text-muted-foreground">
      <div className="page-wrap flex flex-wrap items-center justify-between gap-x-4 gap-y-2 text-xs sm:text-sm">
